...
(function(k) {
    ...
    function Cb(a, b, c, d, e, f) {
        ...
        for (; d !== e; )
            a.hasOwnProperty(d) && (h = g ? b(h, a[d], d, a) : a[d],
            g = !0,
            d += f);
        return h
    }
    ...
    function S(a, b, c, d) {
        ...
        if (l === q)
            return a.iDrawError != e && null === h && (ca(a, 0, "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}" : "'" + f.mData + "'") + " for row " + b + ", column " + c, 4),
            a.iDrawError = e),
            h;
        if ((l === g || null === l) && null !== h && d !== q)
            l = h;
    ...
    function da(a) {
        ...
        var b = function(c, d, e) {
            ...
            for (var g, h, l = 0, n = e.length - 1; l < n; l++) {
                ...
                h && (e[l] = e[l].replace(oa, ""),
                c = c[e[l]](d));
                if (null === c[e[l]] || c[e[l]] === q)
                    c[e[l]] = {};
                c = c[e[l]]
            }
            if (f.match(oa))
    ...
    function ab(a, b, c, d) {
        ...
        var p = function(x, r) {
            if ("string" === typeof x) {
                var A = x.indexOf("@");
                -1 !== A && (A = x.substring(A + 1),
                da(x)(d, r.getAttribute(A)))
            }
        }
          , t = function(x) {
            if (c === q || c === h)
                g = n[h],
                l = x.innerHTML.trim(),
                g && g._bAttrSrc ? (da(g.mData._)(d, l),
                p(g.mData.sort, x),
                p(g.mData.type, x),
                p(g.mData.filter, x)) : m ? (g._setter || (g._setter = da(g.mData)),
                g._setter(d, l)) : d[h] = l;
            h++
        };
        if (f)
    ...
    function fa(a, b) {
        ...
        if (-1 !== k.inArray(!1, c))
            ...
            var d = 0
              ...
              , n = a.aiDisplay;
            a.bDrawing = !0;
            h !== q && -1 !== h && (a._iDisplayStart = l ? h : h >= a.fnRecordsDisplay() ? 0 : h,
            ...
            if (0 !== n.length)
                ...
                g = l ? 0 : h; g < b; g++) {
                    ...
                    if (0 !== f) {
                        var v = e[d % f];
                        p._sRowStripe != v && (k(t).removeClass(p._sRowStripe).addClass(v),
                        p._sRowStripe = v)
                    }
    ...
    function Ib(a) {
        ...
        for (var f = a.sDom.split(""), g, h, l, n, m, p, t = 0; t < f.length; t++) {
            ...
            if ("<" == h) {
                ...
                e = e.parent();
            else if ("l" == h && d.bPaginate && d.bLengthChange)
                g = Jb(a);
            else if ("f" == h && d.bFilter)
                g = Kb(a);
            else if ("r" == h && d.bProcessing)
                g = Lb(a);
            else if ("t" == h)
                g = Mb(a);
            else if ("i" == h && d.bInfo)
                g = Nb(a);
            else if ("p" == h && d.bPaginate)
                g = Ob(a);
    ...
    function Ma(a, b, c) {
        ...
        if (b && Array.isArray(b)) {
            ...
            k.each(b, function(m, p) {
                (m = p.name.match(e)) ? (m = m[0],
                d[m] || (d[m] = []),
                d[m].push(p.value)) : d[p.name] = p.value
            });
            b = d
        }
        var f = a.ajax
        ...
        a.fnServerData ? a.fnServerData.call(g, a.sAjaxSource, k.map(b, function(m, p) {
            ...
            url: f || a.sAjaxSource
        })) : "function" === typeof f ? a.jqXHR = f.call(g, b, h, a) : (a.jqXHR = k.ajax(k.extend(n, f)),
        f.data = l)
    }
    function Gb(a) {
        a.iDraw++;
    ...
    function Pb(a) {
        ...
        for (l = 0; l < c; l++) {
            ...
            m("mDataProp_" + l, n);
            d.bFilter && (m("sSearch_" + l, v.sSearch),
            ...
            if (!h._aFilterData) {
                ...
                for (d = b.length; n < d; n++) {
                    ...
                    if (f.bSearchable) {
                        ...
                        m = "";
                    m.indexOf && -1 !== m.indexOf("&") && (Pa.innerHTML = m,
    ...
    function lb(a, b, c) {
        ...
        0 > d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : ca(a, 0, "Unknown paging action: " + b, 5);
    ...
    function Fa(a) {
        ...
        var f = k(a.nScrollHead)
          ...
          , n = h.children("table");
        h = a.nScrollBody;
        var m = k(h), p = h.style, t = k(a.nScrollFoot).children("div"), v = t.children("table"), x = k(a.nTHead), r = k(a.nTable), A = r[0], D = A.style, I = a.nTFoot ? k(a.nTFoot) : null, W = a.oBrowser, M = W.bScrollOversize, B = T(a.aoColumns, "nTh"), E = [], aa = [], X = [], Aa = [], mb, Ba = function(F) {
            F = F.style;
            F.paddingTop = "0";
            F.paddingBottom = "0";
            F.borderTopWidth = "0";
        ...
        if (a.scrollBarVis !== ha && a.scrollBarVis !== q)
            ...
            r.outerWidth() < f ? (la = h.scrollHeight > h.offsetHeight || "scroll" == m.css("overflow-y") ? f + b : f,
            M && (h.scrollHeight > h.offsetHeight || "scroll" == m.css("overflow-y")) && (D.width = K(la - b)),
            "" !== c && "" === d || ca(a, 1, "Possible column misalignment", 6)) : la = "100%";
            p.width = K(la);
            g.width = K(la);
    ...
    function Ya(a) {
        var b = a.nTable, c = a.aoColumns, d = a.oScroll, e = d.sY, f = d.sX, g = d.sXInner, h = c.length, l = Ga(a, "bVisible"), n = k("th", a.nTHead), m = b.getAttribute("width"), p = b.parentNode, t = !1, v, x = a.oBrowser;
        d = x.bScrollOversize;
        (v = b.style.width) && -1 !== v.indexOf("%") && (m = v);
        for (v = 0; v < l.length; v++) {
            var r = c[l[v]];
            null !== r.sWidth && (r.sWidth = Zb(r.sWidthOrig, p),
            t = !0)
        }
        if (d || !t && !f && !e && h == na(a) && h == n.length)
            ...
            for (v = 0; v < l.length; v++)
                ...
                r.sWidthOrig && f && k(n[v]).append(k("<div/>").css({
                    width: r.sWidthOrig,
                    margin: 0,
                    padding: 0,
                    border: 0,
            ...
            f && g ? h.width(g) : f ? (h.css("width", "auto"),
            h.removeAttr("width"),
            h.width() < p.clientWidth && m && h.width(p.clientWidth)) : e ? h.width(p.clientWidth) : m && h.width(m);
    ...
    function cc(a) {
        ...
        for (var d = 0, e = b.length; d < e; d++) {
            ...
            f.bSortable && (0 < c.length && c[0].col == d ? (l.setAttribute("aria-sort", "asc" == c[0].dir ? "ascending" : "descending"),
            f = g[c[0].index + 1] || g[0]) : f = g[0],
    ...
    function ob(a, b, c, d) {
        ...
        c && a.oFeatures.bSortMulti ? (c = k.inArray(b, T(e, "0")),
        -1 !== c ? (b = g(e[c], !0),
    ...
    function eb(a, b, c, d) {
        var e = a.aoColumns[c];
        pb(b, {}, function(f) {
            !1 !== e.bSortable && (a.oFeatures.bProcessing ? (U(a, !0),
            setTimeout(function() {
                ob(a, c, f.shiftKey, d);
                "ssp" !== P(a) && U(a, !1)
    ...
    function qb(a, b, c) {
        ...
        for (d in b)
            if (b.hasOwnProperty(d)) {
                var e = b[d];
                k.isPlainObject(e) ? (k.isPlainObject(a[d]) || (a[d] = {}),
                k.extend(!0, a[d], e)) : c && "data" !== d && "aaData" !== d && Array.isArray(e) ? a[d] = e.slice() : a[d] = e
            }
        return a
    }
    function pb(a, b, c) {
    ...
    function Ca(a, b) {
        var c = ec.numbers_length
          , d = Math.floor(c / 2);
        b <= c ? a = qa(0, b) : a <= d ? (a = qa(0, c - 2),
        a.push("ellipsis"),
        a.push(b - 1)) : (a >= b - 1 - d ? a = qa(b - (c - 2), b) : (a = qa(a - d + 2, a + d - 1),
        a.push("ellipsis"),
        a.push(b - 1)),
    ...
    var u = function(a) {
        ...
        this.fnGetPosition = function(f) {
            ...
            return "TR" == h ? g.row(f).index() : "TD" == h || "TH" == h ? (f = g.cell(f).index(),
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                ...
                f = function() {
                    ...
                    0 === E.length || 0 === E.children().length ? p.addClass(A.sNoFooter) : 0 < E.length && (r.nTFoot = E[0],
                    wa(r.aoFooter, r.nTFoot));
                    if (g.aaData)
                        for (h = 0; h < g.aaData.length; h++)
                            ea(r, g.aaData[h]);
                    else
                        (r.bDeferLoading || "dom" == P(r)) && Ha(r, k(r.nTBody).children("tr"));
                    r.aiDisplay = r.aiDisplayMaster.slice();
                    r.bInitialised = !0;
                    !1 === n && za(r)
                }
                ;
                g.bStateSave ? (M.bStateSave = !0,
    ...
    k.extend(C.prototype, {
        ...
        iterator: function(a, b, c, d) {
            ...
            return e.length || d ? (a = new C(h,a ? e.concat.apply([], e) : e),
            b = a.selector,
            b.rows = n.rows,
            b.cols = n.cols,
            b.opts = n.opts,
    ...
    C.register = w = function(a, b) {
        if (Array.isArray(a))
            ...
            for (c = d.length; a < c; a++) {
                ...
                e.push(h));
                a === c - 1 ? (h.val = b,
                h.type = "function" === typeof b ? "function" : k.isPlainObject(b) ? "object" : "other") : e = f ? h.methodExt : h.propExt
            }
        }
    }
    ;
    ...
    w("draw()", function(a) {
        return this.iterator("table", function(b) {
            "page" === a ? fa(b) : ("string" === typeof a && (a = "full-hold" === a ? !1 : !0),
            ja(b, !1 === a))
        })
    });
    w("page()", function(a) {
    ...
    var ub = function(a, b, c, d, e) {
      ...
      , Va = function(a, b) {
        ...
        b = b.page;
        if ("ssp" == P(a))
            return "removed" === f ? [] : qa(0, e.length);
        if ("current" == b)
            ...
            a = a.aoData.length; g < a; g++)
                "none" == f ? c.push(g) : (e = k.inArray(g, d),
        ...
        var e = []
          , f = function(g, h) {
            if (Array.isArray(g) || g instanceof k)
                ...
                g.nodeName && "tr" === g.nodeName.toLowerCase() ? e.push(g) : (l = k("<tr><td></td></tr>").addClass(h),
    ...
    var Bc = function(a, b, c) {
        var d = a.aoData, e = Va(a, c), f = kc(Da(d, e, "anCells")), g = k(lc([], f)), h, l = a.aoColumns.length, n, m, p, t, v, x;
            ...
            if (null === r || r === q || A) {
                ...
                for (p = e.length; m < p; m++)
                    ...
                    t = 0; t < l; t++)
                        ...
                        A ? (x = d[h],
                        r(v, S(a, h, t), x.anCells ? x.anCells[t] : null) && n.push(v)) : n.push(v);
                return n
            }
    ...
    w("cells()", function(a, b, c) {
        k.isPlainObject(a) && (a.row === q ? (c = a,
        a = null) : (c = b,
        b = null));
        k.isPlainObject(b) && (c = b,
        b = null);
        if (null === b || b === q)
    ...
    u.tables = u.fnTables = function(a) {
        var b = !1;
        k.isPlainObject(a) && (b = a.api,
        a = a.visible);
        var c = k.map(u.settings, function(d) {
            if (!a || a && k(d.nTable).is(":visible"))
                return d.nTable
        });
        return b ? new C(c) : c
    }
    ...
    w("destroy()", function(a) {
        ...
        return this.iterator("table", function(b) {
            ...
            l.append(g));
            h && e != h.parentNode && (l.children("tfoot").detach(),
            l.append(h));
            b.aaSorting = [];
            b.aaSortingFixed = [];
            Qa(b);
            ...
            (p = b.asDestroyStripes.length) && f.children().each(function(t) {
    ...
    , function(a, b) {
        if (a && !(a instanceof Date) && !tc.test(a))
            return null;
        b = Date.parse(a);
